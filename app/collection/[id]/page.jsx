        ...
        <section className="w-9/12">
          ...
          <section>
            ...
            <div className="flex flex-row items-center gap-4 py-4">
              <div className="font-medium text-lg text-gray-500">{nftData?.contract_ticker_symbol}</div>
              <div className="size-2 bg-gray-300 rounded-full mx-4"></div>
              <div className="font-medium text-lg text-gray-500">{shortenAddress(nftData?.contract_address)}</div>
              <div className="size-2 bg-gray-300 rounded-full mx-4"></div>
              <div className="font-medium text-lg text-gray-500">{sizeFormatter(nftData?.nft_data?.external_data?.asset_size_bytes)} MB</div>
            </div>
